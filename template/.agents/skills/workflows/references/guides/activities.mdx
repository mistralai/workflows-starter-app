...
- Defined as async Python functions decorated with `@workflows.activity()`
...
```python
from mistralai_workflows import run_sticky_worker_session
...
- [Observability Guide](observability.mdx) - Monitor and trace your activities
