...
```python
from mistralai_workflows.models import SchedulePolicy, ScheduleOverlapPolicy
...
from mistralai_workflows.models import ScheduleDefinition, SchedulePolicy, ScheduleOverlapPolicy
...
- [Workflow Guide](workflows.mdx) - Learn workflow fundamentals
- [Signals, Queries & Updates](signals-queries-updates.mdx) - Other workflow interaction methods
