...
sidebar_label: Workflows Exception
...
```python
from mistralai_workflows.exceptions import WorkflowsException, ErrorCode
...
- [Workflows Guide](workflows.mdx) - Learn about workflow fundamentals
- [Activities Guide](activities.mdx) - Learn how to implement activities
